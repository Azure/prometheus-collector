...
6. **Check if the cluster is private link** — query `tsg_triage` → "AKS Cluster Network Settings". Private link clusters commonly have DCR/DCE provisioning failures during addon enablement
