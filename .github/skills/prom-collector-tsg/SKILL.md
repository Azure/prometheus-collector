...
3. Escalate to the MDM team: `CLOUDDIAGNOSTICS\MDM` (Geneva Monitoring\MDM)
...
| MDM Store / dimension limits / silent drops | `CLOUDDIAGNOSTICS\MDM` (Geneva Monitoring\MDM, team ID 28436) |
