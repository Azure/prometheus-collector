...
* TA image - `mcr.microsoft.com/azuremonitor/containerinsights/ciprod/prometheus-collector/images:7.3.0-main-08-10-2026-<TBD>-targetallocator`
* cfg sidecar image - `mcr.microsoft.com/azuremonitor/containerinsights/ciprod/prometheus-collector/images:7.3.0-main-08-10-2026-<TBD>-cfg`
* AKS and Arc Container Images :
  + make the hpa max shards configurable via toggle (https://github.com/Azure/prometheus-collector/pull/1633)
  + set shards to 50 and bump version (https://github.com/Azure/prometheus-collector/pull/1654)
  + Set defaults to 50 as max shards in values.template (https://github.com/Azure/prometheus-collector/pull/1658)
  + Add telemetry for pod and service monitors with basic auth/bearer token (https://github.com/Azure/prometheus-collector/pull/1661)
  + build(deps): bump golang.org/x/net from 0.47.0 to 0.55.0 in /otelcollector/fluent-bit/src (https://github.com/Azure/prometheus-collector/pull/1643)
  + [Generated by SRE Agent] build: bump KSM image and Go toolchain for CVE fixes (ICM 835316916) (https://github.com/Azure/prometheus-collector/pull/1622)
...
* Pipeline/Docs/Templates Updates:
  ...
  + build(deps): bump fast-uri from 3.1.0 to 3.1.5 in /tools/az-prom-rules-converter (https://github.com/Azure/prometheus-collector/pull/1660)
  + build(deps): bump actions/stale from 10 to 11 (https://github.com/Azure/prometheus-collector/pull/1650)
  + build(deps): bump github.com/moby/spdystream from 0.5.0 to 0.5.1 in /otelcollector/test/ginkgo-e2e/querymetrics (https://github.com/Azure/prometheus-collector/pull/1646)
  + build(deps): bump github.com/moby/spdystream from 0.5.0 to 0.5.1 in /otelcollector/test/ginkgo-e2e/livenessprobe (https://github.com/Azure/prometheus-collector/pull/1648)
  + build(deps): bump js-yaml from 4.1.0 to 4.3.1 in /tools/az-prom-rules-converter (https://github.com/Azure/prometheus-collector/pull/1663)
  + Update CI/CD to install ARC version on ci-dev-arc-wcus (https://github.com/Azure/prometheus-collector/pull/1666)
