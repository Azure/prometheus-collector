    ...
    groups+: [
      {
        ...
        rules: [
          ...
          },
          {
            ...
            annotations: {
              description: 'Pod {{ $labels.namespace }}/{{ $labels.pod }} has been in a non-ready state per controller for longer than 15 minutes.',
              summary: 'Pod has been in a non-ready state per controller for more than 15 minutes.',
            },
            'for': '15m',
