    ...
    groups+: [
      {
        ...
        rules: [
          ...
          {
            alert: 'KubeExceedingClusterMemory',
            expr: |||
              sum(kube_pod_container_resource_limits{resource="memory"}) - sum(kube_node_status_capacity_memory_bytes)  >0 
            ||| % $._config,
            labels: {
              severity: 'warning',
            },
            annotations: {
              ...
              summary: 'Memory limits in total exceed the capacity of the cluster',
            },
            'for': '10m',
          },
          {
