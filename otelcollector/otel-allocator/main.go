...
func main() {
	...
	// Add wait in the wrapper for the targetallocator.yaml file to be written by the sidecar to not use the below code
	...
	runGroup.Add(
		func() error {
			...
			// changes here should be resolved by the config.Load() method in the beginning
