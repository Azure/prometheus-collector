...
var DefaultScrapeJobs = map[string]*DefaultScrapeJob{
	...
	"acstor-metrics-exporter": {
		...
		PlaceholderNames:           []string{},
		MinimalKeepListRegex:       "disk_read_operations_completed_total|disk_write_operations_completed_total|disk_read_operations_time_seconds_total|disk_write_operations_time_seconds_total|disk_read_bytes_total|disk_written_bytes_total|disk_reads_merged_total|disk_writes_merged_total|disk_io_now|disk_io_time_seconds_total|disk_io_time_weighted_seconds_total|disk_discard_operations_completed_total|disk_discards_merged_total|disk_discarded_sectors_total|disk_discard_operations_time_seconds_total|disk_flush_requests_total|disk_flush_requests_time_seconds_total|disk_errors_total|disk_readonly_errors_gauge|disk_readonly_status_gauge",
		CustomerKeepListRegex:      "",
		ScrapeInterval:             "30s",
	},
	"local-csi-driver": {
		JobName:                    "local-csi-driver",
		Enabled:                    true,
		OSType:                     OSType.Linux,
		KubernetesPlane:            KubernetesPlane.DataPlane,
		ControllerType:             ControllerType.ReplicaSet,
		ScrapeConfigDefinitionFile: "localCSIDriverDefaultFile.yml",
		PlaceholderNames:           []string{},
		MinimalKeepListRegex:       "rpc.server.duration_milliseconds_bucket|rpc.server.duration_milliseconds_sum|rpc.server.duration_milliseconds_count|rpc_server_duration_milliseconds_bucket|rpc_server_duration_milliseconds_sum|rpc_server_duration_milliseconds_count",
		CustomerKeepListRegex:      "",
		ScrapeInterval:             "30s",
	},
	...
	"istio-cni": {
		...
		KubernetesPlane:            KubernetesPlane.DataPlane,
		ControllerType:             ControllerType.ReplicaSet,
		ScrapeConfigDefinitionFile: "istioCniDefault.yml",
		PlaceholderNames:           []string{},
		MinimalKeepListRegex:       "istio_cni_install_ready|istio_cni_installs_total|nodeagent_reconcile_events_total|ztunnel_connected",
		CustomerKeepListRegex:      "",
		ScrapeInterval:             "30s",
	},
	"waypoint-proxy": {
		JobName:                    "waypoint-proxy",
		Enabled:                    false,
		OSType:                     OSType.Linux,
		KubernetesPlane:            KubernetesPlane.DataPlane,
		ControllerType:             ControllerType.ReplicaSet,
		ScrapeConfigDefinitionFile: "waypointProxyDefault.yml",
		PlaceholderNames:           []string{},
		MinimalKeepListRegex:       "istio_build|istio_requests_total|istio_request_duration_milliseconds_sum|istio_request_duration_milliseconds_count|envoy_cluster_upstream_cx_active|envoy_cluster_upstream_cx_connect_fail|envoy_server_memory_allocated",
		CustomerKeepListRegex:      "",
		ScrapeInterval:             "30s",
	},
}
