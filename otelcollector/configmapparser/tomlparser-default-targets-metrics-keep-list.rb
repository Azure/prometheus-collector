...
@networkobservabilityRetinaRegex_minimal = "networkobservabilityRetina.*|hubble.*|cilium_drop.*|cilium_forward.*"
...
@networkobservabilityRetinaRegex_minimal_mac = "networkobservabilityRetina.*|hubble.*|cilium_drop.*|cilium_forward.*"
