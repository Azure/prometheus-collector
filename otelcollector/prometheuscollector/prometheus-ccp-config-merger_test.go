...
func TestMergeYAML_WithMultipleJobsEnabled_ThenMergedConfigIsComplete(t *testing.T) {
    ...
    // Act
    mergedDefaultConfigs = mergeYAML(mergedDefaultConfigs, config1)
    mergedDefaultConfigs = mergeYAML(mergedDefaultConfigs, config2)
...
func mapToString(convertedMap map[interface{}]interface{}, t *testing.T) string {
    bytes, err := json.Marshal(convertedMap)
