...
try {
    Invoke-WebRequest -Uri https://github.com/microsoft/Docker-Provider/releases/download/ME-OTEL-WINDOWS-TEST/MdmMetricsExtension.2.2022.531.118.nupkg -OutFile /installation/ME/mdmmetricsextension.2.2022.310.234.zip
