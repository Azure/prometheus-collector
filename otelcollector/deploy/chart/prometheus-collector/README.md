...
```shell
helm chart pull mcr.microsoft.com/azuremonitor/containerinsights/cidev:prometheus-collector-chart-main-0.0.5-07-30-2021-4
helm chart export mcr.microsoft.com/azuremonitor/containerinsights/cidev:prometheus-collector-chart-main-0.0.5-07-30-2021-4 .
...
| image.tag | string | Optional | `"prometheus-collector-main-07-30-2021-4"` |  |
