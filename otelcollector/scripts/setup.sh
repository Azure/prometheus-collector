...
curl https://packages.fluentbit.io/centos/7/fluent-bit-3.2.2-1.x86_64.rpm --output fluent-bit-3.2.2-1.x86_64.rpm
sudo tdnf install -y fluent-bit-3.2.2-1.x86_64.rpm
